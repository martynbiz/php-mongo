...
class IntegratedTest extends TestCase
{
	...
	// public function testGetSetAsArrayWithNestedProperties()
    // {
	...
	//
	// 	// assertions
	// 	$this->assertEquals(1, $user['simple']);
	// 	$this->assertEquals(2, $user['nested']['new']);
	// 	$this->assertTrue(isset($user['simple']));
	// 	$this->assertTrue(isset($user['nested']['new']));
	//
	// 	// // modify further
	// 	// $user['nested']['new'] = 3; // <------------ throw an error
    // }

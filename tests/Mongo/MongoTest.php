...
class MongoTest extends MongoTestAbstract
{
	...
	public function testGetDBRefPropertyReturnsObjectWithAllPropertiesFromDB()
    {
		...
		$query = array(
			'_id' => new ObjectID('51b14c2de8e185801f000001'),
		);
		...
		$this->assertEquals(new ObjectID('51b14c2de8e185801f000001'), $user->friend->_id);
    }
	...
	// 	// the return value from the find
	// 	$collectionName = 'users';
	// 	$createdAt = new UTCDateTime(time());
	// 	$userData = $this->getUserData(array(
	...
	//
	// 	// created_at timestamp
	// 	$this->assertEquals($user->created_at, $createdAt);
    // }
	//
    ...
    // }
	//
	// public function testDeleteReturnsFalseWhenObjectIDMissing()
    // {
	// 	// the return value from the find
	// 	$collectionName = 'users';
	//
